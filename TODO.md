...
- [x] **표준 HTTP POST 지원**: Streamable HTTP 도입으로 MCP 표준 호환성 확보 완료.
- [x] **OAuth 2.0 인증 도입**: Dexcom Official API 연동을 위한 OAuth Flow 구현 완료.
